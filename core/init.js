...
client.on('message', async message => {
  ...
  if (message.guild.me.hasPermission("MANAGE_MESSAGES" | "ADMINISTRATOR") && message.member && message.member.roles && muteRole && message.member.roles.cache.has(muteRole.id) && message.guild.owner && message.guild.owner.id !== message.author.id) return message.delete();

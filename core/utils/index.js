...
exports.logs = (data) => {
  ...
  const embed = new MessageEmbed()
    .setColor(0x2F3136)
    .setAuthor(data.initiator.username || data.initiator.displayName, data.initiator.displayAvatarURL({ format: 'png' || 'gif', dynamic: true }) || data.initiator.user.displayAvatarURL({ format: 'png' || 'gif', dynamic: true }))
